package example.client.invoker;
...
import example.client.invoker.auth.Authentication;
import example.client.invoker.auth.HttpBasicAuth;
import example.client.invoker.auth.ApiKeyAuth;
import example.client.invoker.auth.OAuth;
